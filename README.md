...
.
├── mocks/                       # File mocks for testing static assets and modules
│   ├── fileMock.js
│   ├── react-route-dom.js
│   └── styleMock.js
├── docs/                        # Assignment documents and license info
│   ├── assignment-1/
│   ├── assignment-2/
│   ├── assignment-3/
│   └── LICENSE.md
├── eslint.config.js             # ESLint rules and style guide config
├── index.html                   # Root HTML file injected by Vite
...
│   ├── App.jsx                  # Main app component and router wrapper
│   ├── assets/                  # Static assets like images, icons, etc.
│   ├── components/              # Reusable UI components (e.g. headers, footers)
│   ├── pages/                   # Page-level views (e.g. Landing Page, Dashboard)
│   ├── styles/                  # Global and modular CSS files
│   ├── tests/                   # Test files for components and logic
│   ├── main.jsx                 # Entry point that mounts React app
│   └── setupTests.js            # Global test setup for React Testing Library
